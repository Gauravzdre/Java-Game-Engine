...
public class Terrain {
	...
	public Terrain(int gridX, int gridZ, Loader loader, TerrainTexturePack texturePack, TerrainTextures blendMap, String heightMap){
		this.x = gridX * SIZE;
		this.z = gridZ * SIZE;
	...
	private RawModel generateTerrain(Loader loader, String heightMap){
		...
		for(int i=0;i<VERTEX_COUNT;i++){
			for(int j=0;j<VERTEX_COUNT;j++){
				...
				Vector3f normal = calculateLighting(j, i, image);
	...
	private Vector3f calculateLighting(int x, int y, BufferedImage image) {
	...
	public float terrainHeight(float worldX, float worldZ) {
