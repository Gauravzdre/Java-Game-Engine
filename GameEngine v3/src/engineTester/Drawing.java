...
public class Drawing {
	...
	public Drawing() {
		...
		bunny = OBJLoader.loadObjModel("dragon", loader);
		bunnyTexture = new TexturedModel(bunny, new ModelTexture(loader.loadTexture("box")));
	...
	public void draw() {
		...
		// gui = new GuiTextures(loader.loadTexture("health"), new Vector2f(0.5f,0.5f),
